...
var monkey,monkeyImg,monkey1,monkeyr1,monkey_crying;
...
function preload(){
  ...
  monkey_crying = loadImage("monkey_crying.png");
...
function setup() {
  ...
  rope = new Rope(4,{x:390,y:30});
   rope2 = new Rope(4,{x:565,y:30});
   ...
   monkey.addImage("crying",monkey_crying);
  ...
  button.mouseClicked(drop);
   ...
   ground = new Ground(300,400,width,20);
...
function draw() 
{
  ...
  imageMode(CENTER);
  if(banana!=null){
    image(bananaImg,banana.position.x,banana.position.y,30,30);
  }
  pop();
  ...
  if(collide(banana,monkey,60)==true)
  {
  ...
  if(banana!=null && banana.position.y>=350)
  {
    monkey.changeImage('crying');
    monkey.scale = 0.3;
    monkey.velocityX = 0;
    banana=null;
   }
